...
topic = app.topic("SQL_stations", value_type=Station)
# TODO: Define the output Kafka Topic
out_topic = app.topic("SQL_stations_transformed", partitions=1)
# TODO: Define a Faust Table
transtable = app.Table(
...
async def transform_station(stations):
    async for station in stations:
        ...
        if not transtable[station.station_name]:
